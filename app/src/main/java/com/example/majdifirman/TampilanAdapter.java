...
import com.example.majdifirman.model.DataOperasiSistem;

import java.util.ArrayList;

public class TampilanAdapter extends ArrayAdapter {
    ...
    public TampilanAdapter(Context context, ArrayList<DataOperasiSistem> data) {
        super(context, R.layout.tampilan, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.tampilan, parent, false);
